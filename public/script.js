...
async function getAllPizza() {
    ...
    .then((res) => {
        ...
        pizzaJson.map((item, index) => {
            ...
            pizzaItem.querySelector(".pizza-item--img img").src = `/images/${item.photo}`
            ...
            pizzaItem.querySelector("a").addEventListener("click", (e) => {
                ...
                doc(".pizzaBig img").src = /*"images/pizza.png" */`/images/${pizzaJson[key].photo}`//*/;
...
// setInterval(console.log(pizzaJson[1]), 3000)
...
function updateCart() {
    ...
    if(cart.length > 0) {
        ...
        for (let i in cart) {
            ...
            cartItem.querySelector("img").src = `/images/${pizzaItem.photo}`;
